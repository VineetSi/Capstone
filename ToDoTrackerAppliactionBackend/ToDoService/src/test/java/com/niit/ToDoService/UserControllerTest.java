...
public class UserControllerTest {
    ...
    public void setUp() {
        ...
        user1 = new User("kartikey.singh101248@gmail.com", "kartikey", "singh", "12345", "6398445232", listOfOfficialTaskForUser1, listOfPersonalTaskForUser1);
    ...
    public void saveOfficialTaskPositiveTest() throws Exception {
        ...
        mockMvc.perform(post("/api/v2/user/officialTask/kartikey.singh101248@gmail.com")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(user1)))
                        .andExpect(status().isCreated())
                        .andDo(MockMvcResultHandlers.print());
    ...
    public void savePersonalTaskPositiveTest() throws Exception {
        ...
        mockMvc.perform(post("/api/v2/user/personalTask/kartikey.singh101248@gmail.com")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(user1)))
                .andExpect(status().isCreated())
                .andDo(MockMvcResultHandlers.print());
    ...
    public void deleteOfficialTaskPositiveTest() throws Exception {
        ...
        mockMvc.perform(delete("/api/v2/user/officialTask/kartikey.singh101248@gmail.com/1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(user1)))
    ...
    public void deletePersonalTaskPositiveTest() throws Exception {
        ...
        mockMvc.perform(delete("/api/v2/user/personalTask/kartikey.singh101248@gmail.com/1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(user1)))
                        .andExpect(status().isOk())
                        .andDo(MockMvcResultHandlers.print());
    ...
    public void updateOfficialTaskPositiveTest() throws Exception {
        ...
        mockMvc.perform(put("/api/v2/user/officialTask/kartikey.singh101248@gmail.com/1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(user1)))
                        .andExpect(status().isOk())
                        .andDo(MockMvcResultHandlers.print());
    ...
    public void updatePersonalTaskPositiveTest() throws Exception {
        ...
        mockMvc.perform(put("/api/v2/user/personalTask/kartikey.singh101248@gmail.com/1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(user1)))
                        .andExpect(status().isOk())
                        .andDo(MockMvcResultHandlers.print());
    ...
    public void getAllOfficialTaskPositiveTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/user/officialTask/kartikey.singh101248@gmail.com")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(user1)))
                        .andExpect(status().isOk())
                        .andDo(MockMvcResultHandlers.print());
    ...
    public void getAllPersonalTaskPositiveTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/user/personalTask/kartikey.singh101248@gmail.com")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(user1)))
                        .andExpect(status().isOk())
                        .andDo(MockMvcResultHandlers.print());
    ...
    public void sortedOfficialTaskPositiveTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/user/sortedOfficialTask/kartikey.singh101248@gmail.com")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(user1)))
                .andExpect(status().isOk())
                .andDo(MockMvcResultHandlers.print());
    ...
    public void sortedPersonalTaskPositiveTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/user/sortedPersonalTask/kartikey.singh101248@gmail.com")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(user1)))
                .andExpect(status().isOk())
                .andDo(MockMvcResultHandlers.print());
