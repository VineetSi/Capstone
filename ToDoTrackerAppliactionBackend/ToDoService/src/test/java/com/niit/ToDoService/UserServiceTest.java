...
public class UserServiceTest {
    ...
    public void setUp() {
        ...
        user1 = new User("kartikey.singh101248@gmail.com", "kartikey", "singh", "12345", "6398445232", null, null);
    }
    ...
    public void saveOfficialTaskPositiveTestCase() throws UserNotFoundException {
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(user1));
        when(userRepository.save(user1)).thenReturn(user1);
        assertEquals(user1, userServiceImpl.saveOfficialTask("kartikey.singh101248@gmail.com", officialTask1));
    ...
    public void saveOfficialTaskNegativeTestCase() {
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(null));
        assertThrows(UserNotFoundException.class, () -> userServiceImpl.saveOfficialTask("kartikey.singh101248@gmail.com", officialTask2));
        verify(userRepository, times(1)).findById(user1.getUserEmail());
        verify(userRepository, times(0)).save(user1);
    }
    ...
    public void savePersonalTaskPositiveTestCase() throws UserNotFoundException {
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(user1));
        when(userRepository.save(user1)).thenReturn(user1);
        assertEquals(user1, userServiceImpl.savePersonalTask("kartikey.singh101248@gmail.com", personalTask1));
        verify(userRepository, times(2)).findById(user1.getUserEmail());
        verify(userRepository, times(1)).save(user1);
    }
    ...
    public void savePersonalTaskNegativeTestCase() {
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(null));
        assertThrows(UserNotFoundException.class, () -> userServiceImpl.savePersonalTask("kartikey.singh101248@gmail.com", personalTask2));
        verify(userRepository, times(1)).findById(user1.getUserEmail());
        verify(userRepository, times(0)).save(user1);
    }
    ...
    public void deleteOfficialTaskPositiveTestCase() throws UserNotFoundException, TaskNotFoundException {
        ...
        assertEquals(true, userServiceImpl.deleteOfficialTask("kartikey.singh101248@gmail.com", 1));
        verify(userRepository, times(2)).findById(user1.getUserEmail());
        verify(userRepository, times(1)).save(user1);
    }
    ...
    public void deleteOfficialTaskNegativeTestCase() {
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(null));
        assertThrows(UserNotFoundException.class, () -> userServiceImpl.deleteOfficialTask("kartikey.singh101248@gmail.com", 1));
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(user1));
        user1.setOfficialTask(listOfOfficialTaskForUser1);
        assertThrows(TaskNotFoundException.class, () -> userServiceImpl.deleteOfficialTask("kartikey.singh101248@gmail.com", 2));
    ...
    public void deletePersonalTaskPositiveTestCase() throws UserNotFoundException, TaskNotFoundException {
        ...
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(user1));
        when(userRepository.save(user1)).thenReturn(user1);
        assertEquals(true, userServiceImpl.deletePersonalTask("kartikey.singh101248@gmail.com", 1));
        verify(userRepository, times(2)).findById(user1.getUserEmail());
        verify(userRepository, times(1)).save(user1);
    }
    ...
    public void deletePersonalTaskNegativeTestCase() {
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(null));
        assertThrows(UserNotFoundException.class, () -> userServiceImpl.deletePersonalTask("kartikey.singh101248@gmail.com", 1));
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(user1));
        user1.setPersonalTask(listOfPersonalTaskForUser1);
        assertThrows(TaskNotFoundException.class, () -> userServiceImpl.deletePersonalTask("kartikey.singh101248@gmail.com", 2));
        verify(userRepository, times(3)).findById(user1.getUserEmail());
        verify(userRepository, times(0)).save(user1);
    }
    ...
    public void updateOfficialTaskNegativeTestCase() {
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(null));
        assertThrows(UserNotFoundException.class, () -> userServiceImpl.updateOfficialTask("kartikey.singh101248@gmail.com", officialTask1,1));
        verify(userRepository, times(1)).findById(user1.getUserEmail());
        verify(userRepository, times(0)).save(user1);
    }
    ...
    public void updatePersonalTaskPositiveTestCase() throws UserNotFoundException {
        ...
        when(userRepository.save(user1)).thenReturn(user1);
        user1.setPersonalTask(listOfPersonalTaskForUser1);
        assertEquals(user1, userServiceImpl.updatePersonalTask("kartikey.singh101248@gmail.com", personalTask1,1));
        verify(userRepository, times(2)).findById(user1.getUserEmail());
        verify(userRepository, times(1)).save(user1);
    }
    ...
    public void getAllOfficialTasksPositiveTestCase() throws UserNotFoundException {
        user1.setOfficialTask(listOfOfficialTaskForUser1);
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(user1));
        assertEquals(listOfOfficialTaskForUser1, userServiceImpl.getAllOfficialTasks("kartikey.singh101248@gmail.com"));
        verify(userRepository, times(2)).findById(user1.getUserEmail());
    }
    ...
    public void getAllOfficialTasksNegativeTestCase() {
        ...
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(null));
        assertThrows(UserNotFoundException.class, () -> userServiceImpl.getAllOfficialTasks("kartikey.singh101248@gmail.com"));
        verify(userRepository, times(1)).findById(user1.getUserEmail());
    }
    ...
    public void getAllPersonalTasksPositiveTestCase() throws UserNotFoundException {
        user1.setPersonalTask(listOfPersonalTaskForUser1);
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(user1));
        assertEquals(listOfPersonalTaskForUser1, userServiceImpl.getAllPersonalTasks("kartikey.singh101248@gmail.com"));
        verify(userRepository, times(2)).findById(user1.getUserEmail());
    }
    ...
    public void getAllPersonalTasksNegativeTestCase() {
        ...
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(null));
        assertThrows(UserNotFoundException.class, () -> userServiceImpl.getAllPersonalTasks("kartikey.singh101248@gmail.com"));
        verify(userRepository, times(1)).findById(user1.getUserEmail());
    }
    ...
    public void sortedOfficialTaskPositiveTestCase() throws UserNotFoundException{
        ...
        assertEquals(listOfOfficialTaskForUser1, userServiceImpl.getAllOfficialTasks("kartikey.singh101248@gmail.com"));
        verify(userRepository, times(2)).findById(user1.getUserEmail());
        assertEquals(sortedOfficialTaskForUser1, userServiceImpl.sortByPriorityOfOfficialTask("kartikey.singh101248@gmail.com"));
    ...
    public void sortedOfficialTaskNegativeTestCase() throws UserNotFoundException{
        ...
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(null));
        assertThrows(UserNotFoundException.class, () -> userServiceImpl.sortByPriorityOfOfficialTask("kartikey.singh101248@gmail.com"));
        verify(userRepository, times(1)).findById(user1.getUserEmail());
    }
    ...
    public void sortedPersonalTaskPositiveTestCase() throws UserNotFoundException{
        ...
        assertEquals(listOfPersonalTaskForUser1, userServiceImpl.getAllPersonalTasks("kartikey.singh101248@gmail.com"));
        verify(userRepository, times(2)).findById(user1.getUserEmail());
        assertEquals(sortedPersonalTaskForUser1, userServiceImpl.sortByPriorityOfPersonalTask("kartikey.singh101248@gmail.com"));
    ...
    public void sortedPersonalTaskNegativeTestCase() throws UserNotFoundException{
        ...
        when(userRepository.findById(user1.getUserEmail())).thenReturn(Optional.ofNullable(null));
        assertThrows(UserNotFoundException.class, () -> userServiceImpl.sortByPriorityOfPersonalTask("kartikey.singh101248@gmail.com"));
        verify(userRepository, times(1)).findById(user1.getUserEmail());
    }
