...
public class ArchiveControllerTest {
    ...
    public void setUp() {
        ...
        archive = new Archive(1, "jagdishbhalke@gmail.com", null,null);
        archive1 = new Archive(1, "jagdishbhalke@gmail.com", taskList1,taskList2);
        archive2 = new Archive(1, "jagdishbhalke@gmail.com", taskList2,taskList3);
        archive3 = new Archive(1, "jagdishbhalke@gmail.com", taskList3,taskList1);
    ...
    public void getOfficialTasklistByUserEmailPositiveTest() throws Exception {
        ...
        mockMvc.perform(get("/archiveservice/archive/officialTask/jagdishbhalke@gmail.com")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(archive1)))
                .andExpect(status().isOk())
                .andDo(MockMvcResultHandlers.print());
    ...
    public void getPersonalTasklistByUserEmailPositiveTest() throws Exception {
        ...
        mockMvc.perform(get("/archiveservice/archive/personalTask/jagdishbhalke@gmail.com")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(archive1)))
                .andExpect(status().isOk())
                .andDo(MockMvcResultHandlers.print());
