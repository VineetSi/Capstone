...
public class ArchiveServiceTest {
    ...
    public void setUp() {
        ...
        archive1 = new Archive(1, "jagdishbhalke@gmail.com", officialTaskList1,null);
        archive2 = new Archive(1, "jagdishbhalke@gmail.com", null,officialTaskList1);
        archive3 = new Archive(1, "jagdishbhalke@gmail.com", officialTaskList3,personalTaskList3);
    ...
    public void saveOfficialTaskToArchiveNegativeTestCase() {
        ...
        when(archiveRespository.findByUserEmail("jagdishbhalke@gmail.com")).thenReturn(archive1);
